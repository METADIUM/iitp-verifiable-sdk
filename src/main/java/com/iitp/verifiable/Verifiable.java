...
public abstract class Verifiable {
	...
	public static final String JSONLD_CREDENTIAL_SCHEMA = "credentialSchema";
	...
	/**
	 * Set Type list of credential
	 * @param types
	 */
	public void setTypes(Collection<String> types) {
		jsonObject.put(JSONLD_KEY_TYPE, types);
	}
	 ...
	 * @param cs
	 */
	public void setCredentialSchema(Object cs) {
		jsonObject.put(JSONLD_CREDENTIAL_SCHEMA, cs);
	}
	 ...
	 * @return may be Map
	 */
	public Object getCredentialSchema() {
		return jsonObject.get(JSONLD_CREDENTIAL_SCHEMA);
	}
}
